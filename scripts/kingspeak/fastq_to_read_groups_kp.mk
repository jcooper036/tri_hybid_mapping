...
all: ${dir}/merge/${sample}_sorted_rg.bam # should be the files that need to be complete
...
## add read groups
${check}/${sample}_readgroup.txt: ${check}/${sample}_index.txt
	...
	RGID=${sample} \
	RGSM=${sample}
	touch ${check}/${sample}_readgroup.txt

## send them all to the same file
${dir}/merge/${sample}_sorted_rg.bam: ${dir}/merge/${sample}_sorted_rg.bam
	mv ${dir}/bam/${sample}_sorted_rg.bam  ${dir}/merge/${sample}_sorted_rg.bam
